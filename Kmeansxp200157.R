...
View(titanic)
write.csv(titanic,file="C:/Users/nandy/DataViz/titanicNew.csv")
titanic<-read.csv("C:/Users/nandy/DataViz/titanicNew.csv")
...
titanicNew=read.csv("C:/Users/nandy/DataViz/titanicNew.csv")
...
write.csv(titanicUpdated,file = "C:/Users/nandy/DataViz/titanicUpdated.csv")
